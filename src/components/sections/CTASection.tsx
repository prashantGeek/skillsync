        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 bg-white/20 border border-white/30 rounded-full flex items-center justify-center mb-4">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
              </div>
              <h3 className="text-lg font-semibold text-white mb-2">No Credit Card Required</h3>
              <p className="text-purple-100 text-sm">Start your trial instantly without any payment information</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-purple-100 text-sm">Get help whenever you need it from our expert support team</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-purple-100 text-sm">Bank-level security with SOC 2 compliance and SSO integration</p>
            </div>
          </div>
        </div>
      </div>

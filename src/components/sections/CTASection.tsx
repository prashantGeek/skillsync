...
export default function CTASection() {
 ...
 <Button size="lg" className="bg-yellow-500 hover:bg-yellow-600 :bg-yellow-500 text-black font-bold px-8">
 Start Free 30-Day Trial
 </Button>
 <Button variant="outline" size="lg" className="border-white text-white hover:bg-white hover:text-blue-700 :bg-gray-300 :text-gray-900 px-8">
 Schedule a Demo
 </Button>
 </div>
